    ...
    CommunityStorageV1
{
    ...
    /**
     * @notice Returns the usdc contract address
     * todo: to be removed, use token() instead
     */
    function usdc() public view override returns (IERC20) {
        return address(_token) != address(0) ? _token : communityAdmin.usdc();
    }
     ...
     */
    function savingHistoryAddress() public pure override returns (address) {
        return address(0);
    }
    ...
    function updateToken(
        ...
        require(
            _newToken == communityAdmin.usdc() || _treasury.isToken(address(_newToken)),
